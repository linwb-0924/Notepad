...
//        SimpleAdapter simpleAdapter = new SimpleAdapter(this,listItems,R.layout.noteslist_item,from,viewIDs);
//        listView.setAdapter(simpleAdapter);
//        listView.setOnItemClickListener(new AdapterView.OnItemClickListener(){
//            @Override
//            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l){
//                Toast.makeText(getApplicationContext(),dataColumns[i],Toast.LENGTH_LONG).show();
//            }
//
//        });
